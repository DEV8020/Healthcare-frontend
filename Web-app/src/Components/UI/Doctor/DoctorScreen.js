...
return (
    <div>
      ...
      {createEncounter === true &&  (<EncounterScreen  setAlertMessage={props.setAlertMessage}
          setAlertFlag={props.setAlertFlag} setCreateEncounter={setCreateEncounter}/>)
      ...
      <div className={classes.center}>
        ...
        <div className={classes.Doctor_menu}>
          <Button value="New Encounter" onClick={NewEncounterButtonHandler} />
